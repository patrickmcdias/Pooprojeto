...
public class ColecaoFuncionario {
	...
	/**
	 * MÃ©todo que instÃ¢ncia o atributo Func como ArrayList
	 */
	...
	public Funcionario pesquisarPelaMatricula(String n) {
		...
		for (Funcionario fu : Func) {
			if (fu.getMatricula().equals(n)) {
				System.out.println("FuncionÃ¡rio " + fu.toString());
				funcio = fu;
				k++;
			}
		}
		if (k == 0) {
			System.out.println("NÃ£o temos funcionÃ¡rio com essa matrÃ­cula");
		}
		return funcio;
	}
